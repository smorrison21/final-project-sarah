...
# switch year to date
enrollment_wide = enrollment_wide.rename(columns={
    'Year': 'Date'
})

# Create year as an int column
enrollment_wide['Year'] = enrollment_wide['Date'].dt.year
...
quality_summary['Year'] = quality_summary['Year']
quality_summary['percent_benchmarks'] = quality_summary['sum_benchmarks']/quality_summary['total_benchmarks']
```

```{python}
quality_standards = quality_standards.sort_values(by=['State Name', 'Year', 'Variable Name'], ascending=[True, True, True])
```
```{python}
